      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl border border-green-200 p-6 hover:shadow-md transition-all">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-green-700 mb-1">Comisiones Ganadas</p>
          ...
          <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl border border-purple-200 p-6 hover:shadow-md transition-all">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-purple-600">{stats?.activeReferrals || 0}</p>
              </div>
              ...
              <table className="w-full">
                <thead className="bg-secondary-50 border-b border-secondary-200">
                  <tr>
                    ...
                    <th className="text-left py-4 px-6 font-semibold text-secondary-900">Comisión Ganada</th>
                    <th className="text-left py-4 px-6 font-semibold text-secondary-900">Fecha Registro</th>
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <ul className="text-blue-700 text-sm space-y-1">
                ...
                <li>• Las comisiones se acreditan automáticamente a tu saldo</li>
                <li>• Puedes retirar tus comisiones en cualquier momento</li>
